...
def train_model(fer_train, fer_train_labels, fer_test, fer_test_labels, model_file='best_fer_model.h5', batch_size=64, epochs=1000):
...
preds = model.evaluate(fer_train, fer_train_labels)
print(f'Model Accuracy for Test Dataset: {preds[1] * 100} %\nModel Loss for Test Dataset: {preds[0]}')
