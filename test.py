...
class MusicPlayerApp:
    ...
    def __init__(self, root2):
        self.root2 = root2
        self.root2.title("Music Player")
        self.playing = False

        # middle frame

        label3 = ttk.Label(root2, background='#0a4a54')
        ...
        label4 = ttk.Label(root2, background='#0f6c7a')
...
class CameraApp:
    ...
    def __init__(self,parent2,music_player_app_instance,video_source=0):
        self.parent2 = parent2

        self.video_source = video_source
        self.music_player_app_instance = music_player_app_instance
        self.vid = cv2.VideoCapture(self.video_source)
        label3 = ttk.Label(parent2, background='#0a4a54')
        self.playing = False
        ...
        label4 = ttk.Label(parent2, background='#0f6c7a')
        label4.place(relx=0.475, rely=0.13, relwidth=0.3, relheight=0.7)
        label8 = ttk.Label(parent2, background='#0f6c7a')
        ...
        self.youtube_frame = tk.Frame(parent2, bg="white")
        ...
        label5 = ttk.Label(parent2, background='#0a4a54')
        label5.place(relx=0.785, rely=0.13, relwidth=0.2, relheight=0.7)
        ...
        label6 = ttk.Label(parent2, background='#0f6c7a')
    ...
    def Capture_photo(self,model,cam_id=0):
        ...
        while True:
            ...
            for rect in rects:
                ...
                if self.emotions[emotion_idx] != [0, 1]:
            ...
            if cv2.waitKey(3) & cv2.imwrite("captured_photo.png", frame):
                break
...
def main():
    ...
    os.system("pkill -f 'python main2.py'")
    root2 = tk.Tk()
    style = ttk.Style()

    root2.title('Emotion Based Music PLayer')
    root2.geometry("1300x600")
    root2.configure(bg="#0b798c")
